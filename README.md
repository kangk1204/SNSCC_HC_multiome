...
_Local note:_ the scripts in this folder are the updated set (previously kept under `new/`). If you change file names or paths, please keep this README in sync.
